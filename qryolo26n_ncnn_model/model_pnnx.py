...
class Model(nn.Module):
    def __init__(self):
        ...
        self.model_23_cv2_0_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(3,3), out_channels=16, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_70 = nn.SiLU()
        self.model_23_cv2_0_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=16, kernel_size=(3,3), out_channels=16, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_71 = nn.SiLU()
        self.model_23_cv2_0_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=16, kernel_size=(1,1), out_channels=4, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.model_23_cv2_1_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=128, kernel_size=(3,3), out_channels=16, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_72 = nn.SiLU()
        self.model_23_cv2_1_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=16, kernel_size=(3,3), out_channels=16, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_73 = nn.SiLU()
        self.model_23_cv2_1_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=16, kernel_size=(1,1), out_channels=4, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.model_23_cv2_2_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=256, kernel_size=(3,3), out_channels=16, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_74 = nn.SiLU()
        self.model_23_cv2_2_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=16, kernel_size=(3,3), out_channels=16, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_75 = nn.SiLU()
        self.model_23_cv2_2_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=16, kernel_size=(1,1), out_channels=4, padding=(0,0), padding_mode='zeros', stride=(1,1))
        ...
        self.model_23_cv3_0_0_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(1,1), out_channels=64, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_77 = nn.SiLU()
        self.model_23_cv3_0_1_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=64, in_channels=64, kernel_size=(3,3), out_channels=64, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_78 = nn.SiLU()
        self.model_23_cv3_0_1_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(1,1), out_channels=64, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_79 = nn.SiLU()
        self.model_23_cv3_0_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(1,1), out_channels=1, padding=(0,0), padding_mode='zeros', stride=(1,1))
        ...
        self.model_23_cv3_1_0_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=128, kernel_size=(1,1), out_channels=64, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_81 = nn.SiLU()
        self.model_23_cv3_1_1_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=64, in_channels=64, kernel_size=(3,3), out_channels=64, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_82 = nn.SiLU()
        self.model_23_cv3_1_1_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(1,1), out_channels=64, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_83 = nn.SiLU()
        self.model_23_cv3_1_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(1,1), out_channels=1, padding=(0,0), padding_mode='zeros', stride=(1,1))
        ...
        self.model_23_cv3_2_0_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=256, kernel_size=(1,1), out_channels=64, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_85 = nn.SiLU()
        self.model_23_cv3_2_1_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=64, in_channels=64, kernel_size=(3,3), out_channels=64, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_86 = nn.SiLU()
        self.model_23_cv3_2_1_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(1,1), out_channels=64, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_87 = nn.SiLU()
        self.model_23_cv3_2_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(1,1), out_channels=1, padding=(0,0), padding_mode='zeros', stride=(1,1))

        archive = zipfile.ZipFile('qryolo26n_ncnn_model/model.pnnx.bin', 'r')
        ...
        self.model_23_cv2_0_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.0.0.conv.bias', (16), 'float32')
        self.model_23_cv2_0_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.0.0.conv.weight', (16,64,3,3), 'float32')
        self.model_23_cv2_0_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.0.1.conv.bias', (16), 'float32')
        self.model_23_cv2_0_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.0.1.conv.weight', (16,16,3,3), 'float32')
        self.model_23_cv2_0_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.0.2.bias', (4), 'float32')
        self.model_23_cv2_0_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.0.2.weight', (4,16,1,1), 'float32')
        self.model_23_cv2_1_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.1.0.conv.bias', (16), 'float32')
        self.model_23_cv2_1_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.1.0.conv.weight', (16,128,3,3), 'float32')
        self.model_23_cv2_1_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.1.1.conv.bias', (16), 'float32')
        self.model_23_cv2_1_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.1.1.conv.weight', (16,16,3,3), 'float32')
        self.model_23_cv2_1_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.1.2.bias', (4), 'float32')
        self.model_23_cv2_1_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.1.2.weight', (4,16,1,1), 'float32')
        self.model_23_cv2_2_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.2.0.conv.bias', (16), 'float32')
        self.model_23_cv2_2_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.2.0.conv.weight', (16,256,3,3), 'float32')
        self.model_23_cv2_2_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.2.1.conv.bias', (16), 'float32')
        self.model_23_cv2_2_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.2.1.conv.weight', (16,16,3,3), 'float32')
        self.model_23_cv2_2_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.2.2.bias', (4), 'float32')
        self.model_23_cv2_2_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv2.2.2.weight', (4,16,1,1), 'float32')
        ...
        self.model_23_cv3_0_0_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.0.0.1.conv.bias', (64), 'float32')
        self.model_23_cv3_0_0_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.0.0.1.conv.weight', (64,64,1,1), 'float32')
        self.model_23_cv3_0_1_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.0.1.0.conv.bias', (64), 'float32')
        self.model_23_cv3_0_1_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.0.1.0.conv.weight', (64,1,3,3), 'float32')
        self.model_23_cv3_0_1_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.0.1.1.conv.bias', (64), 'float32')
        self.model_23_cv3_0_1_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.0.1.1.conv.weight', (64,64,1,1), 'float32')
        self.model_23_cv3_0_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.0.2.bias', (1), 'float32')
        self.model_23_cv3_0_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.0.2.weight', (1,64,1,1), 'float32')
        ...
        self.model_23_cv3_1_0_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.1.0.1.conv.bias', (64), 'float32')
        self.model_23_cv3_1_0_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.1.0.1.conv.weight', (64,128,1,1), 'float32')
        self.model_23_cv3_1_1_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.1.1.0.conv.bias', (64), 'float32')
        self.model_23_cv3_1_1_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.1.1.0.conv.weight', (64,1,3,3), 'float32')
        self.model_23_cv3_1_1_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.1.1.1.conv.bias', (64), 'float32')
        self.model_23_cv3_1_1_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.1.1.1.conv.weight', (64,64,1,1), 'float32')
        self.model_23_cv3_1_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.1.2.bias', (1), 'float32')
        self.model_23_cv3_1_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.1.2.weight', (1,64,1,1), 'float32')
        ...
        self.model_23_cv3_2_0_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.2.0.1.conv.bias', (64), 'float32')
        self.model_23_cv3_2_0_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.2.0.1.conv.weight', (64,256,1,1), 'float32')
        self.model_23_cv3_2_1_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.2.1.0.conv.bias', (64), 'float32')
        self.model_23_cv3_2_1_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.2.1.0.conv.weight', (64,1,3,3), 'float32')
        self.model_23_cv3_2_1_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.2.1.1.conv.bias', (64), 'float32')
        self.model_23_cv3_2_1_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.2.1.1.conv.weight', (64,64,1,1), 'float32')
        self.model_23_cv3_2_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.2.2.bias', (1), 'float32')
        self.model_23_cv3_2_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv3.2.2.weight', (1,64,1,1), 'float32')
        self.pnnx_262_data = self.load_pnnx_bin_as_parameter(archive, 'pnnx_262.data', (1,8400,), 'float32')
    ...
    def forward(self, v_0):
        ...
        v_215 = torch.transpose(v_212, dim0=-2, dim1=-1)
        v_216 = torch.matmul(v_215, other=v_213)
        v_217 = (v_216 * 0.176777)
        v_218 = F.softmax(v_217, dim=-1)
        v_219 = torch.transpose(v_218, dim0=-2, dim1=-1)
        v_220 = torch.matmul(v_214, other=v_219)
        ...
        v_234 = self.pnnx_262_data
        v_235 = self.model_23_cv2_0_0_conv(v_170)
        v_236 = self.pnnx_unique_70(v_235)
        v_237 = self.model_23_cv2_0_1_conv(v_236)
        v_238 = self.pnnx_unique_71(v_237)
        v_239 = self.model_23_cv2_0_2(v_238)
        v_240 = v_239.reshape(1, 4, 6400)
        v_241 = self.model_23_cv2_1_0_conv(v_197)
        v_242 = self.pnnx_unique_72(v_241)
        v_243 = self.model_23_cv2_1_1_conv(v_242)
        v_244 = self.pnnx_unique_73(v_243)
        v_245 = self.model_23_cv2_1_2(v_244)
        v_246 = v_245.reshape(1, 4, 1600)
        v_247 = self.model_23_cv2_2_0_conv(v_233)
        v_248 = self.pnnx_unique_74(v_247)
        v_249 = self.model_23_cv2_2_1_conv(v_248)
        v_250 = self.pnnx_unique_75(v_249)
        v_251 = self.model_23_cv2_2_2(v_250)
        v_252 = v_251.reshape(1, 4, 400)
        v_253 = torch.cat((v_240, v_246, v_252), dim=-1)
        v_254 = self.model_23_cv3_0_0_0_conv(v_170)
        v_255 = self.pnnx_unique_76(v_254)
        v_256 = self.model_23_cv3_0_0_1_conv(v_255)
        v_257 = self.pnnx_unique_77(v_256)
        v_258 = self.model_23_cv3_0_1_0_conv(v_257)
        v_259 = self.pnnx_unique_78(v_258)
        v_260 = self.model_23_cv3_0_1_1_conv(v_259)
        v_261 = self.pnnx_unique_79(v_260)
        v_262 = self.model_23_cv3_0_2(v_261)
        v_263 = v_262.reshape(1, 1, 6400)
        v_264 = self.model_23_cv3_1_0_0_conv(v_197)
        v_265 = self.pnnx_unique_80(v_264)
        v_266 = self.model_23_cv3_1_0_1_conv(v_265)
        v_267 = self.pnnx_unique_81(v_266)
        v_268 = self.model_23_cv3_1_1_0_conv(v_267)
        v_269 = self.pnnx_unique_82(v_268)
        v_270 = self.model_23_cv3_1_1_1_conv(v_269)
        v_271 = self.pnnx_unique_83(v_270)
        v_272 = self.model_23_cv3_1_2(v_271)
        v_273 = v_272.reshape(1, 1, 1600)
        v_274 = self.model_23_cv3_2_0_0_conv(v_233)
        v_275 = self.pnnx_unique_84(v_274)
        v_276 = self.model_23_cv3_2_0_1_conv(v_275)
        v_277 = self.pnnx_unique_85(v_276)
        v_278 = self.model_23_cv3_2_1_0_conv(v_277)
        v_279 = self.pnnx_unique_86(v_278)
        v_280 = self.model_23_cv3_2_1_1_conv(v_279)
        v_281 = self.pnnx_unique_87(v_280)
        v_282 = self.model_23_cv3_2_2(v_281)
        v_283 = v_282.reshape(1, 1, 400)
        v_284 = torch.cat((v_263, v_273, v_283), dim=-1)
        v_285 = self.pnnx_fold_anchor_points_1_data
        v_286, v_287 = torch.chunk(v_253, chunks=2, dim=1)
        v_288 = (v_285 - v_286)
        v_289 = (v_285 + v_287)
        v_290 = ((v_288 + v_289) / 2)
        v_291 = (v_289 - v_288)
        v_292 = torch.cat((v_290, v_291), dim=1)
        v_293 = (v_292 * v_234)
        v_294 = F.sigmoid(v_284)
        v_295 = torch.cat((v_293, v_294), dim=1)
        return v_295
...
def export_torchscript():
    ...
    mod.save("qryolo26n_ncnn_model/model_pnnx.py.pt")
...
def export_onnx():
    ...
    torch.onnx.export(net, v_0, "qryolo26n_ncnn_model/model_pnnx.py.onnx", export_params=True, operator_export_type=torch.onnx.OperatorExportTypes.ONNX_ATEN_FALLBACK, opset_version=13, input_names=['in0'], output_names=['out0'])
...
def export_pnnx():
    ...
    import pnnx
    pnnx.export(net, "qryolo26n_ncnn_model/model_pnnx.py.pt", v_0)
